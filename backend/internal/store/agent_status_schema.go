...
// EnsureAgentStatusSchema keeps operator monitoring compatible with existing
// local and VPS database volumes whose migrations have not yet been replayed.
func (s *Store) EnsureAgentStatusSchema(ctx context.Context) error {
